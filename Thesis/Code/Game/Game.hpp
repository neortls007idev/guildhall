...
public:
	...
	GPUMesh*					m_quadMesh;
	GPUMesh*					m_objCityMesh[ NUM_CITIES ];
	GPUMesh*					m_objSciFiShipMeshes[ NUM_SCIFI_SHIPS ];
	Transform					m_cubeMeshTransform;
	Transform					m_sphereMeshTransform;
	Transform					m_quadTransform;
	Transform					m_objCityTransform[ NUM_CITIES ];
	Transform					m_objSciFiShipTransform[ NUM_SCIFI_SHIPS ];
	Texture*					m_meshTex_D											= nullptr;
	Texture*					m_meshTex_N											= nullptr;
	Texture*					m_tileDiffuse										= nullptr;
	Texture*					m_tileNormal										= nullptr;
	Texture*					m_objCityMeshTex_Diffuse[ NUM_CITIES ];
	Texture*					m_objCityMeshTex_Normal[ NUM_CITIES ];
	Texture*					m_objScifiShipMeshTex_Diffuse[ NUM_SCIFI_SHIPS ];
	Texture*					m_objScifiShipMeshTex_Normal[ NUM_SCIFI_SHIPS ];
