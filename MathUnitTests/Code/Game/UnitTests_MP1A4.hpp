...
#define Function_PushDiscOutOfPoint2D		PushDiscOutOfPoint
#define Function_PushDiscOutOfDisc2D		PushMobileDiscOutOfFixedDisc
#define Function_PushDiscsOutOfEachOther2D	PushMobileDiscOutOfEachOther
#define Function_PushDiscOutOfAABB2D		PushDiscOutOfAABB
...
#define Function_GetTaxicabDistance2D		GetTaxiCabLengthBetweenTwoPoints
#define Function_IsPointInForwardSector2D	IsPointInSector
