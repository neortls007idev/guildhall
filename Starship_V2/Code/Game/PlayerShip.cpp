					...
					orientation)
{
	...
	m_shipTexture = g_theRenderer->GetOrCreateTextureFromFile( "Data/Images/ss2_1.png" );
}
...
void PlayerShip::Render() const
{
	...
	for (int vertIndex = 0; vertIndex < NUM_SHIP_VERTS; vertIndex++)
	{
		...
		tempVerts[vertIndex].m_color = m_shipColor;
	...
	g_theRenderer->BindTexture( m_shipTexture );
	g_theRenderer->DrawAABB2( m_localShip , WHITE );
