...
std::string GameTCPServer::ReceiveClientMessage( SOCKET client , char* bufferAddr , int bufferLength )
{
...
void GameTCPServer::SendClientMessage( SOCKET client )
{
