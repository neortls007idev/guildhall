...
void NpcTank::Update( float deltaSeconds )
{
	...
	Map* currentMap = m_theGame->m_world->m_currentMap;
	
	m_whiskers[0] = m_theGame->m_world->m_currentMap->RayCast( m_position , Vec2( CosDegrees( m_orientationDegrees ) , SinDegrees( m_orientationDegrees ) ) , 0.5f );
	m_whiskers[1] = m_theGame->m_world->m_currentMap->RayCast( m_position - Vec2( 0.2f * CosDegrees( m_orientationDegrees ) , 0.2f * SinDegrees( m_orientationDegrees ) ).GetRotated90Degrees() , Vec2( CosDegrees( m_orientationDegrees ) , SinDegrees( m_orientationDegrees ) ) , 0.5f );
	m_whiskers[2] = m_theGame->m_world->m_currentMap->RayCast( m_position + Vec2( 0.2f * CosDegrees( m_orientationDegrees ) , 0.2f * SinDegrees( m_orientationDegrees ) ).GetRotated90Degrees() , Vec2( CosDegrees( m_orientationDegrees ) , SinDegrees( m_orientationDegrees ) ) , 0.5f );
